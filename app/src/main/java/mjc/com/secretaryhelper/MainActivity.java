...
public class MainActivity extends Activity implements ActionBar.TabListener {
    ...
    private ListView publisherListView;

    /**
     * The {@link ViewPager} that will host the section contents.
     */
    SecretaryPager mViewPager;
    PublisherRecordFragment mPublisherRecordFragment;
    PublisherGroupFragment mPublisherGroupFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager = (SecretaryPager) findViewById(R.id.pager);
        mViewPager.setAdapter(mSectionsPagerAdapter);

        // When swiping between different sections, select the corresponding
        // tab. We can also use ActionBar.Tab#select() to do this if we have
        // a reference to the Tab.
        mViewPager.setOnPageChangeListener(new SecretaryPager.SimpleOnPageChangeListener() {
            @Override
